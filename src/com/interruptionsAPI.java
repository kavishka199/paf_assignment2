...
public class interruptionsAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output =itemObj.insertInterruptions(request.getParameter("ID"), 
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request); 
		 String output = itemObj.updateInterruption(paras.get("ID").toString(), 
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		 ...
		 Map paras = getParasMap(request); 
		 String output = itemObj.deleteInterruption(paras.get("id").toString()); 
		 response.getWriter().write(output); 
	}
